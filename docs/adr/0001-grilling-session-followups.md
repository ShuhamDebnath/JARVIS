...
5. `docs/workflows/workflow-3-social-media-engine.md` — Q11 structural rewrite + pin content → CEO → automation handoff + Q12 testing checklist annotations (3a vs 3b).
6. `docs/roadmap.md` — Q10 tool additions to Phase 1 + Phase 6 step lists; Q12 Phase 3 split into 3a/3b; Q14 cost_guard wiring entry; Q12 Phase 0c trigger rewrite ("before Phase 3b").
